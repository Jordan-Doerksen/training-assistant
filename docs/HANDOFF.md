...
- **P2 — territory operating (in progress):** ~~OCS 301–315~~ ✅ (done 2026-06-21, tag `ocs`).
  Remaining: CTC 560–578 → ABS 500s → Interlocking 600–620 (only their definitions exist).
  Plus SCS 351–353 (short).
